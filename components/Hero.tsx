...
const Hero: React.FC = () => {
  return (
    <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 bg-[#4a5d4e] text-[#f5f2ed] px-6 overflow-hidden">
      ...
      <div className="absolute top-20 right-[5%] w-32 h-32 md:w-48 md:h-48 rounded-full border border-[#f5f2ed]/20 flex items-center justify-center animate-pulse">
        <div className="text-[10px] uppercase tracking-widest text-center">
          Explore<br/>Flavour<br/>↓
        </div>
      </div>
        ...
        <div className="relative flex justify-center lg:justify-end">
          ...
          <div className="relative w-full max-w-md aspect-square">
            ...
            <div className="absolute top-0 right-0 w-full h-full rounded-full overflow-hidden border-8 border-[#f5f2ed]/10">
              <img 
                src="https://picsum.photos/seed/oliveoil/800/800" 
                alt="Product in setting" 
            ...
            <div className="absolute -bottom-10 -left-10 w-48 h-48 rounded-full overflow-hidden border-4 border-[#4a5d4e]">
              <img src="https://picsum.photos/seed/herbs/300/300" alt="Ingredients" className="w-full h-full object-cover" />
            </div>
            <div className="absolute top-10 -left-16 w-32 h-16 rounded-full overflow-hidden border-4 border-[#4a5d4e]">
               <img src="https://picsum.photos/seed/vinegar/200/100" alt="Detail" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </div>
