    ...
    <footer className="bg-[#2c3a2e] text-[#f5f2ed]/60 py-12 px-6">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="flex gap-6 items-center">
          <a
            href="https://www.facebook.com/squirrelMadeProducts"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Facebook"
            className="flex items-center gap-2 text-xs font-medium uppercase tracking-widest hover:text-[#f5f2ed] transition-colors"
          >
          ...
          <a
            href="https://www.instagram.com/squirrelmadeproducts"
            target="_blank"
            rel="noopener noreferrer"
